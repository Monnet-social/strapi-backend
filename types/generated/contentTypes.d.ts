...
export interface ApiAlgorithmControlAlgorithmControl
  extends Struct.CollectionTypeSchema {
  collectionName: 'algorithm_controls';
  info: {
    displayName: 'Algorithm Control';
    pluralName: 'algorithm-controls';
    singularName: 'algorithm-control';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    categories_entry: Schema.Attribute.Component<
      'global.algo-category-entry',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    followings: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
      ...
      > &
      Schema.Attribute.DefaultTo<50>;
    friends: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recommendations: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    commented_by: Schema.Attribute.Relation<
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiDislikeDislike extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disliked_by: Schema.Attribute.Relation<
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFileOptimisationFileOptimisation
  ...
  info: {
    displayName: 'File Optimisation';
    pluralName: 'file-optimisations';
...
export interface ApiFollowingFollowing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    follower: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    is_close_friend: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_mature: Schema.Attribute.Boolean;
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    reported_post: Schema.Attribute.Relation<'oneToOne', 'api::post.post'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.Component<'location.location', false>;
    mesibo_id: Schema.Attribute.String;
    mesibo_token: Schema.Attribute.String;
    name: Schema.Attribute.String;
